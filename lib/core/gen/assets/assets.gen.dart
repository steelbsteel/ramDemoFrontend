...
class $AssetsEnvGen {
  ...
  /// File path: assets/env/dev.json
  String get dev => 'assets/env/dev.json';
...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/alert_circle.svg
  SvgGenImage get alertCircle =>
      const SvgGenImage('assets/icons/alert_circle.svg');

  /// List of all assets
  List<SvgGenImage> get values => [alertCircle];
}
...
class $AssetsL10nGen {
  ...
  /// File path: assets/l10n/ru.l10n.json
  String get ruL10n => 'assets/l10n/ru.l10n.json';

  /// List of all assets
  List<String> get values => [ruL10n];
}
